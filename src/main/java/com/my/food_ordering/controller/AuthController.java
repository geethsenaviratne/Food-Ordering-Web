...
import com.my.food_ordering.Response.AuthResponse;
import com.my.food_ordering.config.JwtProvider;
...
import com.my.food_ordering.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<AuthResponse>createUserHandler(@RequestParam User user) throws Exception {
